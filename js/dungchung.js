...
<div class="header group">
      <div class="logo">
          <a href="index.html">
              <img src="img/product/g3.png" alt="LOGO" title="LOGO">
          </a>
      </div> <!-- End Logo -->
...
function addFooter() {
  ...
  <div class="copy-right">
      <p><a href="index.html">Group3 PC Store</a> - All rights reserved © 2023 - Designed by
          <span style="color: #eee; font-weight: bold">Group 3</span></p>
  </div>`);
}
  ...
  javascript: (function () {
    ...
    (function () {
      ...
      for (var li of li_s) {
        ...
        switch (loai) {
          case "CPU:":
            result.detail.cpu = giatri.replace('"', "'");
            break;
          case "Mainboard:":
            result.detail.mainboard = giatri;
            break;
          case "Ram:":
            result.detail.ram = giatri;
            break;
          case "Ổ cứng:":
            result.detail.ocung = giatri;
            break;
          case "VGA:":
            result.detail.vga = giatri;
            break;
          case "Nguồn máy tính:":
            result.detail.nguonmaytinh = giatri;
            break;
          case "Vỏ case:":
            result.detail.vocase = giatri;
            break;
          case "Tản nhiệt:":
            result.detail.tannhiet = giatri;
            break;
          case "Chú thích:":
            result.detail.chuthich = giatri;
            break;
        }
      }
